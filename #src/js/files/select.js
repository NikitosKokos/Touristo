    const selectSingle = document.querySelectorAll('._select');
    const selectSingle_title = document.querySelectorAll('._select__title');
...
if(selectSingle){
    selectSingle.forEach((element,index) => {
            ...
            let selectSingle_labels = element.querySelectorAll('._select__label');
